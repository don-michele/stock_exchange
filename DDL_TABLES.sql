...
(
	...
	acquisition_price DECIMAL(8, 4) UNSIGNED NOT NULL,
	acquisition_quantity DECIMAL(5, 2) UNSIGNED NOT NULL,
	acquisition_delta_error DECIMAL(4, 3) NOT NULL,
...
(
	...
	average_acquisition_price DECIMAL(8, 4) NOT NULL,
	current_acquisition_delta_error DECIMAL(4, 3) NOT NULL,
	sale_price DECIMAL(8, 4) UNSIGNED NOT NULL,
	sale_quantity DECIMAL(5, 2) UNSIGNED NOT NULL,
	sale_taf_value DECIMAL(7, 3) UNSIGNED NOT NULL,
	sale_delta_error DECIMAL(4, 3) NOT NULL,
...
(
	...
	current_avg_acq_price DECIMAL(8, 4) NOT NULL,
	current_acq_delta_error DECIMAL(4, 3) NOT NULL,
